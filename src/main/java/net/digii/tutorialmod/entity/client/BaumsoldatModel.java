...
public class BaumsoldatModel<T extends BaumsoldatEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Baumsoldat = modelPartData.addChild("Baumsoldat", ModelPartBuilder.create().uv(0, 16).cuboid(-3.9F, 12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 32).cuboid(-3.9F, 12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F))
		.uv(16, 48).cuboid(-0.1F, 12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 48).cuboid(-0.1F, 12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F))
		.uv(40, 16).cuboid(-8.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
		.uv(40, 32).cuboid(-8.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F))
		.uv(32, 48).cuboid(4.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
		.uv(48, 48).cuboid(4.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.25F))
		...
		ModelPartData head = Baumsoldat.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
